  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-prompt antialiased text-gray-900 overflow-x-hidden">
      ...
      <main>
        ...
        <section id="contact" className="py-24 sm:py-40 bg-brand-pink relative overflow-hidden reveal">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center text-white max-w-5xl">
            <span className="inline-block px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-white/20 border border-white/30 text-white text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-8 sm:mb-10">
              Personalized Consultation
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-8 sm:mb-10 leading-snug">เริ่มวางแผนความมั่นคง <br className="hidden sm:block" />ระดับ <span className="italic">Exclusive</span> วันนี้</h2>
            <p className="text-lg sm:text-xl lg:text-2xl mb-12 sm:mb-20 opacity-90 max-w-2xl mx-auto font-medium leading-relaxed px-4">
