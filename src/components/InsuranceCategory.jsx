...
const InsuranceCategory = ({ categories, activeCategory, setActiveCategory }) => {
  const getIcon = (iconName) => {
    switch (iconName) {
      ...
      case 'users':
        return (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 01-9-3.812M13.993 8.391a3 3 0 11-5.987 0 3 3 0 015.987 0z" />
          </svg>
        );
      case 'chart':
        return (
